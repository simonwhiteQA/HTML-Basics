...
let ditto = pokeData();
let preparedPokemon = preparePokemon(ditto);
console.log("PREPARED POKEMON OBJECT: ");
console.log(preparedPokemon);
console.log("PREPARED POKEMON JSON STRING: " + JSON.stringify(preparedPokemon));

function preparePokemon(pokemonData) {
    const preparedPokemon = new Pokemon(pokemonData);
